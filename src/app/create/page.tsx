  ...
  return (
    <ConsoleLayout title='Create OneLink'>
      <Box sx={ { maxWidth: 820, mx: 'auto', px: { md: 4, xs: 2 }, py: { md: 8, xs: 5 }, width: '100%' } }>
        <Typography sx={ { color: 'text.primary', typography: 'pageTitle', fontWeight: 700, mb: 1 } }>
          Choose a creation type
        </Typography>
        <Typography sx={ { color: 'text.secondary', typography: 'bodyMd', mb: 3.5 } }>
        ...
        <Stack direction={ { md: 'row', xs: 'column' } } spacing={ 2 }>
          ...
          >
            <Typography sx={ { color: 'text.primary', typography: 'headlineSm', fontWeight: 600, mb: 1 } }>
              Single link
            </Typography>
            <Typography sx={ { color: 'text.secondary', typography: 'bodyMd', mb: 2.5 } }>
