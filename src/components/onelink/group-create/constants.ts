...
export const SNIPPET_WHEEL_SIDE_CONTEXT = 28;
export const SNIPPET_WHEEL_FALLBACK_WINDOW = 84;
export const SNIPPET_WHEEL_SPACER = (SNIPPET_WHEEL_VIEWPORT_HEIGHT - SNIPPET_WHEEL_ITEM_HEIGHT) / 2;
